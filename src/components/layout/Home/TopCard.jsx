    ...
    return (
        <Link to={destination()}>
            <div
                ...
                className="w-72 h-96 border-2 border-white/20 bg-color rounded-3xl px-10 py-8 shadow-2xl flex flex-col justify-between transition-all duration-300 hover:scale-[1.02] hover:shadow-xl cursor-pointer"
                >
                ...
                <div className="flex-grow bg-2 rounded-2xl mb-4 p-5 space-y-2 flex flex-col justify-center">
